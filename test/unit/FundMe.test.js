...
// yarn hardhat test -grep "some text of the test"
...
describe("FundMe", async function () {
    ...
    beforeEach(async function () {
        // will get all account for hardhat, account from config.js for testnet
        // const account = await ethers.getSigners();
        // const account0 = account[0];
    ...
    describe("withdraw", async function () {
        ...
        it("withdraw eth from single funder", async () => {
            ...
            // big number uses special function for doing calculations
